        ...
        <div className="p-4 md:p-8">
          ...
          <div className="mt-8">
            ...
            <p>
              ...
              houden. Je wilt natuurlijk niet van iemand vandoor gaat met jouw
              persoonsgegevens. Terecht ook. We vragen wel gegevens van jou,
              zodat we je zo goed mogelijk kunnen helpen. Welke gegevens we
              vragen en waarvoor we ze gebruiken lees je hieronder. Ook zie je
              wat je rechten zijn, wie toegang heeft tot je data en hoe lang we
            ...
            <p>
              Dankzij cookies hoef je niet steeds dezelfde informatie in te
              voeren of te downloaden wanneer je bij ons terugkomt. Bovendien
              helpen ze ons inzien hoe je onze sites gebruikt en hoe wij de boel
              beter en klantvriendelijker kunnen maken. Het moet gezegd worden:
              we gebruiken ze ook voor marketingdoeleinden. Het staat je vrij om
