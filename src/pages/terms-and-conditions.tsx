  ...
  return (
    <div className='p-4 md:p-8 '>
      ...
      <div className='flex flex-col gap-2 mt-4'>
        ...
        <div className='flex flex-col gap-2 mt-4'>
          <h1 className='font-semibold'>7. Beëindiging of ontbinding lidmaatschap</h1>
          <div className='px-4'>
            <p>
            ...
            <div>
              ...
              Vinci Club mag de lidmaatschapsovereenkomst ontbinden zonder ingebrekestelling of mededeling:
