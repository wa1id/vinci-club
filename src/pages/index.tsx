...
const Home = () => {
  return (
    <div className='bg-black   min-h-screen  p-4'>
          ...
          <div className='flex flex-col p-2 px-8 w-full gap-4 mx-auto '>
            <div className='flex  gap-2'>
              <IoIosCall
                ...
                size={20}
              />
              <div className='text-white'>+32 470 70 27 50</div>
            </div>
            ...
            <div className='flex  gap-2'>
              <GrMail
                ...
                size={20}
              />
              <div className='text-white'>info@vinci-club.be</div>
            </div>
            ...
            <div className='flex  gap-2'>
              ...
              <div className='text-white'>
                A 2100 Antwerpen (Deurne), Cruyslei 54 A
              </div>
            </div>
          </div>
        </div>
      ...
      <p className='text-white text-center mt-8 sm:mt-16'>
